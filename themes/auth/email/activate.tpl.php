        ...
        <td bgcolor="#ffffff" align="center">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 500px;" class="wrapper">
                <tr>
					...
					<td align="right" style="font-size: 22px; font-family: Helvetica, Arial, sans-serif; color: #333333; padding-top: 15px;" class="padding-copy">ACTIVATE YOUR ACCOUNT</td>
                </tr>
            </table>
            <!--[if (gte mso 9)|(IE)]>
            </td>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td align="left" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">
									...
									Your account already registered but have not been activate yet
									
									<?php echo sprintf(lang('email_activate_subheading'), anchor('auth/activate/'. $id .'/'. $activation, lang('email_activate_link')));?>
									
									Your Password : <br />
									<strong style="color:#27aae1;"><?php echo $password; ?></strong>
