...
*/
$config['tables']['users']           = 'ln_users';
$config['tables']['groups']          = 'ln_groups';
$config['tables']['users_groups']    = 'ln_users_groups';
$config['tables']['login_attempts']  = 'ln_login_attempts';
 ...
 */
$config['site_title']                 = "Luve Content Management System";       // Site Title, example.com
$config['admin_email']                = "noreply@luftinurfahmi.net"; // Admin Email, admin@example.com
