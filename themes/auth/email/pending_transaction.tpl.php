        ...
        <td bgcolor="#ffffff" align="center">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 500px;" class="wrapper">
                <tr>
					...
					<td align="right" style="font-size: 22px; font-family: Helvetica, Arial, sans-serif; color: #333333; padding-top: 15px;" class="padding-copy">PENDING TRANSACTION</td>
                </tr>
            </table>
            <!--[if (gte mso 9)|(IE)]>
            </td>
                    ...
                    <td>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
								...
								Thank you for your order at Deepick. Once we have received your payment, we will send you an email confirmation. Please check your order confirmation below:
								</td>
                            </tr>
                        </table>
                    </td>
    ...
    <tr>
        <td bgcolor="#ffffff" align="center" style="padding: 15px; padding-top:5px;" class="padding">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 500px;" class="responsive-table">
                                            ...
                                            <td style="padding: 0 0 10px 0;">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tr>
														...
														Purchased Item (<?php echo $value['qty']; ?> X  <?php echo $value['price']; ?>)
														<br>
														<?php echo $value['name']; ?>
														(Size :  <?php echo $value['options']['size']; ?>)
														</td>
                                                    </tr>
                                                </table>
                                            </td>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="47%" style="width: 47%;" align="right">
                                        <tr>
                                            <td style="padding: 0 0 10px 0;">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tr>
                                                        <td align="right" style="font-family: Arial, sans-serif; color: #333333; font-size: 14px;"> <?php echo $value['options']['subtotal']; ?></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
				...
				<tr>
				<td style="padding: 10px 0 0 0; border-top: 1px dashed #000;"></td>
				</tr>
							<tr>
                                <td valign="top" class="mobile-wrapper">
                                    <!-- LEFT COLUMN -->
                                    <table cellpadding="0" cellspacing="0" border="0" width="57%" style="width: 57%;" align="left">
                                        <tr>
                                            <td style="padding: 0 0 10px 0;">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tr>
                                                        <td align="right" style="font-family: Arial, sans-serif; color: #333333; font-size: 14px;">
														Item Subtotal
														</td>
                                                    </tr>
                                                </table>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="27%" style="width:27%;" align="right">
                                        <tr>
                                            <td style="padding: 0 0 10px 0;">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tr>
                                                        <td align="right" style="font-family: Arial, sans-serif; color: #333333; font-size: 14px;"><?php echo $subtotal; ?></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="27%" style="width:27%;" align="right">
                                        <tr>
                                            <td style="padding: 0 0 10px 0;">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tr>
                                                        <td align="right" style="font-family: Arial, sans-serif; color: #333333; font-size: 14px;"><?php echo $shippingcost; ?></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="27%" style="width:27%;" align="right">
                                        <tr>
                                            <td style="padding: 0 0 10px 0;">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tr>
                                                        <td align="right" style="font-family: Arial, sans-serif; color: #333333; font-size: 14px;"><?php echo $totalcart; ?></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                ...
                                <td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                         ...
                                         <tr>
                                            <td align="left" style="padding: 0 0 0 0; font-size: 14px; line-height: 18px; font-family: Helvetica, Arial, sans-serif; color: #000; font-style: italic;" class="padding-copy">
												Please activate and login to your account to process the payment <a href="<?php echo base_url().'auth/login'; ?>"
											</td>
                                        </tr>
                                    </table>
                                </td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="max-width: 500px;" class="responsive-table">
                <tr>
                    <td align="left" style="font-size: 12px; line-height: 18px; font-family: Helvetica, Arial, sans-serif; color:#666666;">
						Please contact us at order@public-culture.com if you need any assistance regarding your order
                    </td>
					
                </tr>
				 <tr>
                    <td align="left" style="font-size: 12px; line-height: 18px; font-family: Helvetica, Arial, sans-serif; color:#000;">
						<a href="<?php echo base_url(); ?>">www.public-culture.com</a>
