        ...
        <td bgcolor="#ffffff" align="center">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 500px;" class="wrapper">
                <tr>
					...
					<td align="right" style="font-size:16px; font-family: Helvetica, Arial, sans-serif; color: #333333; padding-top: 15px;" class="padding-copy">PAYMENT CONFIRMATION</td>
                </tr>
            </table>
            <!--[if (gte mso 9)|(IE)]>
            </td>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td align="left" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">
									Dear Admin, <br>
									Your Customer Have Submit Wire Transfer Confirmation Please Validate
								</td>
                            </tr>
                        </table>
                    </td>
                                         ...
                                         <tr>
                                            <td align="left" style="padding: 0 0 0 0; font-size: 14px; line-height: 18px; font-family: Helvetica, Arial, sans-serif; color: #000; font-style: italic;" class="padding-copy">
												<ul style="text-align: left !important;">
													...
													<li>Account Name  : <?php echo $accountName; ?></li>
													<li>Acc Number	  : <?php echo $accountNumber; ?></li>
													<li>Bank From	  : <?php echo $bankFrom; ?></li>
													<li>Amount		  : <?php echo $amount; ?></li>
													<li>Transfer Date : <?php echo $dateTransfer; ?></li>
													<li>Receipt Scan  : <?php echo base_url().'uploads/'.$receiptScan; ?></li>
												</ul>
											</td>
                                        </tr>
                                    </table>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="max-width: 500px;" class="responsive-table">
                <tr>
                    <td align="left" style="font-size: 12px; line-height: 18px; font-family: Helvetica, Arial, sans-serif; color:#666666;">
						Please check in admin area <a href="<?php echo base_url().'admin'; ?>">deepick.co/admin</a>
                    </td>
